...
public class SearchElementInRotatedSortedArray2 {
    ...
    public static int serachElementInSortedArray2(int[] nums, int target) {
        int low = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The target value present at index: " + serachElementInSortedArray2(values, targetValue));
